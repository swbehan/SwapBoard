...
const contacts = [
  ...
  "celine@university.edu",
  "alex@university.edu",
  "priya@university.edu",
  "tom@university.edu",
  "sarah@university.edu",
  "devon@university.edu",
  "sam@university.edu",
...
const academicListings = [
  {
    ...
    description: "McMurry, barely used. No highlighting.",
  },
  {
    title: "Calculus: Early Transcendentals",
    description: "Stewart 8th edition. Some pencil marks.",
  },
  {
    title: "Introduction to Psychology",
    description: "Myers 12th edition. Good condition.",
  },
  {
    title: "Biology: Life on Earth",
    description: "Audesirk 10th ed. Highlighted but readable.",
  },
  {
    title: "Physics for Scientists and Engineers",
    description: "Serway 9th ed. Spine intact.",
  },
  {
    title: "Microeconomics textbook",
    description: "Mankiw 8th edition. Light use.",
  },
  {
    title: "Macroeconomics textbook",
    description: "Mankiw 7th edition. Some notes.",
  },
  {
    title: "Linear Algebra textbook",
    description: "Lay 5th edition. Clean copy.",
  },
  {
    title: "Discrete Mathematics",
    description: "Rosen 8th ed. Used one semester.",
  },
  {
    title: "Data Structures & Algorithms",
    description: "CLRS 4th edition. Heavy but complete.",
  },
  {
    title: "Computer Networks textbook",
    description: "Tanenbaum 5th ed. Good condition.",
  },
  {
    title: "Operating Systems textbook",
    description: "Silberschatz 10th ed. Minor wear.",
  },
  {
    title: "Statistics for Business",
    description: "Berenson 14th ed. Includes access code.",
  },
  {
    title: "Introduction to Sociology",
    description: "Giddens 8th edition. Lightly used.",
  },
  {
    title: "American History textbook",
    description: "Henretta 9th ed. Good shape.",
  },
  {
    title: "Anatomy & Physiology",
    description: "Marieb 10th ed. Some highlighting.",
  },
  {
    title: "Chemistry: The Central Science",
    description: "Brown 14th ed. Clean copy.",
  },
  {
    title: "Political Science textbook",
    description: "O'Connor 12th ed. Minor notes.",
  },
  {
  ...
  },
  {
    ...
    description: "FX-115ES Plus. Like new.",
  },
  {
    title: "Graphing calculator TI-Nspire",
    description: "CX II, barely used.",
  },
  {
    title: "Spanish language workbook",
    description: "Vistas 6th ed. Unused exercises.",
  },
  {
    title: "French textbook",
    description: "Vis-à-vis 6th ed. Good condition.",
  },
  {
    title: "Philosophy reader",
    description: "Pojman anthology. Annotated but legible.",
  },
  {
    title: "English Literature anthology",
    description: "Norton 9th ed. Some highlighting.",
  },
  {
    title: "Research Methods textbook",
    description: "Creswell 4th ed. Clean.",
  },
  {
    title: "Environmental Science",
    description: "Cunningham 14th ed. Good shape.",
  },
  {
    title: "Introduction to Marketing",
    description: "Kotler 16th ed. Barely used.",
  },
  {
    title: "Financial Accounting textbook",
    description: "Weygandt 10th ed. Minor wear.",
  },
  {
    title: "Art History survey book",
    description: "Stokstad 5th ed. Heavy but clean.",
  },
];

const furnitureListings = [
  {
    title: "IKEA KALLAX shelf (2x4)",
    description: "White, great condition. Self-pickup.",
  },
  {
    title: "Desk lamp (LED, adjustable)",
    description: "Three brightness levels. USB port on base.",
  },
  {
    title: "Twin XL mattress topper",
    description: "Memory foam, 2 inches. Washed.",
  },
  {
    title: "Desk chair (ergonomic)",
    description: "Black mesh. Adjustable height.",
  },
  {
    title: "Study desk (IKEA MICKE)",
    description: "White, scratches on top. Functional.",
  },
  {
    title: "Bookshelf (5 shelves)",
    description: "Dark brown. Sturdy and solid.",
  },
  ...
  {
    title: "Tension rod set",
    description: "Adjustable. For closets or windows.",
  },
  {
    title: "Over-door organizer",
    description: "6 pockets. Fits standard dorm doors.",
  },
  {
    title: "Under-bed storage (2 boxes)",
    description: "Rolling, fits twin XL.",
  },
  { title: "Shower caddy", description: "Chrome. Some rust spots but works." },
  {
    title: "Mirror (full length)",
    description: "Leaning style. No frame damage.",
  },
];
...
const clothingListings = [
  {
    ...
    description: "Navy blue. Light pilling on sleeves.",
  },
  {
    title: "Formal Blazer (W, Size 6)",
    description: "Black. Worn twice. Career fair ready.",
  },
  {
    title: "Winter Boots (Size 9)",
    description: "Sorel Caribou. Waterproof. Good tread.",
  },
  {
    title: "Rain jacket (unisex M)",
    description: "Columbia. Folds into pocket.",
  },
  {
    title: "Dress pants (M 32x30)",
    description: "Charcoal gray. Dry cleaned.",
  },
  {
    title: "White dress shirt (M)",
    description: "Non-iron. Worn a few times.",
  },
  ...
  {
    title: "Heels (W, Size 7)",
    description: "Nude, block heel. Work appropriate.",
  },
  ...
  {
    title: "Ski jacket (M)",
    description: "Blue. Waterproof. Used one season.",
  },
  { title: "Cardigan (W, S)", description: "Cream. Soft knit. Minor pilling." },
  {
    title: "Formal dress (W, 4)",
    description: "Navy. Knee length. Worn once.",
  },
];
...
const electronicsListings = [
  {
    ...
    description: "1080p. HDMI + DisplayPort. Works great.",
  },
  {
    title: "Mechanical Keyboard (TKL)",
    description: "Blue switches. White backlight.",
  },
  {
    title: "Laptop stand (aluminum)",
    description: "Adjustable. Fits 13-17 inch.",
  },
  {
    title: "USB-C hub (7-in-1)",
    description: "HDMI, USB, SD card. Works perfectly.",
  },
  {
    title: "Wireless mouse",
    description: "Logitech MX Master. Excellent condition.",
  },
  {
    title: "External hard drive 1TB",
    description: "Seagate. USB 3.0. Works perfectly.",
  },
  {
    title: "Webcam (1080p)",
    description: "Logitech C920. Includes original box.",
  },
  {
  ...
  {
    title: "iPad (6th gen)",
    description: "32GB. Some scratches on back. Works great.",
  },
  {
    title: "Kindle Paperwhite",
    description: "8GB. Waterproof. Includes case.",
  },
  {
    title: "Portable charger 20000mAh",
    description: "Anker. Charges 3 devices.",
  },
  ...
  { title: "Ethernet cable (25ft)", description: "Cat6. Never used." },
  {
    ...
    description: "With USB ports. Braided cord.",
  },
  {
    title: "Smart LED light strip",
    description: "16ft. RGB. Works with Alexa.",
  },
  {
    title: "Graphic tablet (Wacom)",
    description: "Small. For digital art/design.",
  },
  { title: "Blue Yeti microphone", description: "Silver. Stand included." },
  {
    title: "Ring light (10 inch)",
    description: "With phone holder. 3 color modes.",
  },
  {
    title: "Switch Lite (yellow)",
    description: "Works perfectly. No games included.",
  },
];
...
const otherListings = [
  {
    ...
    description: "Black. Dorm-sized. Cools well.",
  },
  {
    title: "Coffee maker (Keurig K-Mini)",
    description: "Barely used. Clean and works.",
  },
  ...
  {
    title: "Cleaning supplies kit",
    description: "Mop, bucket, broom, dustpan.",
  },
  {
    title: "Tool kit (basic)",
    description: "Hammer, screwdrivers, wrench, pliers.",
  },
  { title: "Extension cord (10ft)", description: "3-prong. Indoor use." },
  {
    title: "Board game (Catan)",
    description: "Complete set. All pieces present.",
  },
];
...
async function seed() {
  ...
  try {
    ...
    console.log(
      `✓ Total: ${listResult.insertedCount + reqResult.insertedCount} records`
    );
